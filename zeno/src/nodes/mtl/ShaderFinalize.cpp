...
struct ShaderFinalize : INode {
    virtual void apply() override {
        ...
        auto code = em.finalizeCode({
            ...
            get_input<IObject>("sheenTintColor", std::make_shared<NumericObject>(vec3f(1,1,1))),
            ...
            get_input<IObject>("emissionIntensity", std::make_shared<NumericObject>(float(1.0))),
